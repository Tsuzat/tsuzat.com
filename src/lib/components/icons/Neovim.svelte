...
<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128" {...rest}>
	<defs>
		<linearGradient
			id="deviconNeovim0"
			x1=".5"
	...
	<g fill-rule="evenodd">
		...
		<path
			...
			transform="translate(10.95 -.352)scale(.82614)"
		/>
		<path fill-opacity="0.129" d="m38.53 50.01l-.04 4.244l-21.743-32.18l2.014-2.06zm0 0" />
	</g>
</svg>
